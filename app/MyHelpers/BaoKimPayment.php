...
class BaoKimPayment
{
    ...
    // Mã merchante site 
    private $merchant_id = '27391';    // Biến này được baokim.vn cung cấp khi bạn đăng ký merchant site

    // Mật khẩu bảo mật
    private $secure_pass = '8a577039c925a9fd'; // Biến này được baokim.vn cung cấp khi bạn đăng ký merchant site
     ...
     */
    public function verifyResponseUrl($a = array())
    {
        $checksum = $a['checksum'];
        unset($a['checksum']);
